...
public class OpenWithEditorExtensionManager {
	public static String EXTENSION_POINT = "org.jboss.tools.jst.text.ext.openWithEditorExtension"; //$NON-NLS-1$

	static OpenWithEditorExtension[] INSTANCES;

	public static OpenWithEditorExtension[] getInstances() {
		...
		INSTANCES = list.toArray(new OpenWithEditorExtension[0]);
